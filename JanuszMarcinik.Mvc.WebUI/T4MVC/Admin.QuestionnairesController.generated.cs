...
{
    public partial class QuestionnairesController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected QuestionnairesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public QuestionnairesController Actions { get { return MVC.Admin.Questionnaires; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Questionnaires";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Questionnaires";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_QuestionnairesController : JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers.QuestionnairesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Questionnaires.QuestionnaireViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Questionnaires.QuestionnaireViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Questionnaires.QuestionnaireViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Questionnaires.QuestionnaireViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
