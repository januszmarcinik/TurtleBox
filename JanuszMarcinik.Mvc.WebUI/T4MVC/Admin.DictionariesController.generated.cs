...
namespace JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers
{
    public partial class DictionariesController
    {
        ...
        protected DictionariesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DictionariesController Actions { get { return MVC.Admin.Dictionaries; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Dictionaries";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Dictionaries";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Admin/Views/Dictionaries/Create.cshtml";
            public readonly string Delete = "~/Areas/Admin/Views/Dictionaries/Delete.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/Dictionaries/Edit.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DictionariesController : JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers.DictionariesController
    {
        public T4MVC_DictionariesController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Dictionaries.DictionaryViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Dictionaries.DictionaryViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Dictionaries.DictionaryViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Dictionaries.DictionaryViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
