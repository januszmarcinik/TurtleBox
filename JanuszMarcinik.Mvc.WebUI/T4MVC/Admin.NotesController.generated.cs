...
namespace JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers
{
    public partial class NotesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public NotesController Actions { get { return MVC.Admin.Notes; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Admin/Views/Notes/Create.cshtml";
            public readonly string Delete = "~/Areas/Admin/Views/Notes/Delete.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/Notes/Edit.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_NotesController : JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers.NotesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Notes.NoteViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Notes.NoteViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Notes.NoteViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Notes.NoteViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
